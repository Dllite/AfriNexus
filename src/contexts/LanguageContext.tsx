...
const translations = {
  fr: {
    ...
    'about.vision.content': 'Devenir un catalyseur du développement économique durable en Afrique en facilitant les partenariats stratégiques public-privé et en encourageant l\'attractivité des États africains.',
  ...
  en: {
    ...
    'about.president.title': 'President\'s Message',
    'about.president.quote': 'Africa has extraordinary economic potential that just needs to be revealed. At AfriNexus Forum, we are committed to becoming a catalyst for sustainable economic development by facilitating strategic partnerships between public and private sectors. Our vision is to strengthen the attractiveness of African states and create fruitful exchange spaces between African and international companies.',
